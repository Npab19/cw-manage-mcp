...
const pag: Schema = {
  ...
  orderBy: z.string().optional().describe('Sort expression, e.g. "expectedCloseDate asc"'),
...
const withOpportunityId: Schema = { id: z.number().int().describe('Opportunity ID'), ...pag };
const byOpportunityId: Schema = { id: z.number().int().describe('Opportunity ID'), fields: z.string().optional().describe('Fields to return') };
